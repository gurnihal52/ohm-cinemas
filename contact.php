<?php include('header.php'); ?>
	...
	<div class="col-md-12 " style="margin-top:0px;">
		<div class="col-md-10 col-md-offset-1 feed" style="margin-bottom:0px; ">
			<h3>Contact Us</h3>
			<hr>
			<p><i class="fa fa-phone"></i> +00-00000000</p>
		...
		<div class="col-md-10 col-md-offset-1 feed" style=" margin-top:15px">
			...
			<div class="col-md-12"><p><label>Your FeeBack</label><textarea name="feedback" placeholder="Your FeeBack" required></textarea></p></div>
			<div class="col-md-4">
